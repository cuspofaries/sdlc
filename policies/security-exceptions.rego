...
#
# Data input: data.exceptions.exceptions[] (YAML converted to JSON)
# =============================================================================
package sbom
...
deny contains msg if {
	some i, exception in data.exceptions.exceptions
...
deny contains msg if {
	some exception in data.exceptions.exceptions
	exception.expires != ""
